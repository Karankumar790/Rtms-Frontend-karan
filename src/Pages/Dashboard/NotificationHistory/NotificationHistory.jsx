  ...
  return (
    <div>
      ...
      <Modal open={open} onClose={handleClose}>
        <Grid container lg={6} sx={style}>
          <Grid container>
            {/* --------------------------------Textfield Values------------------------------------- */}
            <Grid container mx={2} mt={3}>
              <Grid container>
                <Paper sx={{ mr: "50px" }}>
                  <Grid item lg={3} md={3} sm={6} xs={12} p={2} mr={9}>
                    <Box>
                ...
                <Paper sx={{ width: "650px" }}>
                  ...
                  <Grid item lg={3} md={3} sm={6} xs={12} p={2}>
                    {[
            ...
            {/* --------------------------------Remark------------------------------------- */}
            <Grid container component={Paper} p={2} mt={3} mx={2}>
              <Grid
                item
                lg={12}
                md={2}
                ...
                alignItems="center"
              >
                <Textarea aria-label="minimum height" minRows={10} placeholder="REMARK" />
              </Grid>
