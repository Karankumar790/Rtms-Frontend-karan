...
export default function SuperAdmin() {
  ...
  //   try {
  //     const response = await generateOtpOragnization(formData);// Ensure sendOtpRegister handles FormData
  //     if (response.success) {
  //       dispatch(
  ...
  try {
    ...
    if (response && response.success) {  // Make sure response is valid and has success property
      dispatch(
        setOragnizationDetails({
          organizationName: formValues.organizationName,
          username: formValues.username,
