...
const handleAddInstallation = async () => {
  ...
  const updateMapLocation = ({ latitude, longitude }) => {
    // Example for updating map location (adjust based on your map library)
    mapRef.current.panTo({ lat: latitude, lng: longitude });
    // Optionally, add a marker at the specified coordinates
  ...
  const handleLocationClick = async (wellNumber, organizationName) => {
    try {
      ...
      if (data?.success) {
        ...
        console.log(coordinates,"coorediasd.........")
