...
export default function Sidebar({ open, mobileOpen, handleDrawerClose, handleDrawerTransitionEnd, handleDrawerToggle }) {
    ...
    const menuItems = [
        ...
        { name: "Manage Nodes", icon: <DeviceManagerIcon sx={{ color: 'black' }} />, path: "/dashboard/DeviceManage" },
        { name: "Manager Gateway", icon: <Networkicon sx={{ color: 'black' }} />, path: "/dashboard/Network" },
